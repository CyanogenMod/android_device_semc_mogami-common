...
public class ProParts extends PreferenceActivity  implements Preference.OnPreferenceChangeListener
{
    ...
    private void setNewKeyboardLanguage(String language){
        ...
        String keychar1 = filesDir + "/qwerty."+language+".kcm";
        ...
        if (ShellInterface.isSuAvailable()){
            ...
            //commandsList.append("rm /system/usr/keychars/us104-keyboard.kcm ; ");
            commandsList.append("cp " + keychar1 + " /system/usr/keychars/pm8058-keypad.kcm ; ");
            commandsList.append("chown 0:0 /system/usr/keychars/pm8058-keypad.kcm ; ");
            commandsList.append("chmod 644 /system/usr/keychars/pm8058-keypad.kcm ; ");
